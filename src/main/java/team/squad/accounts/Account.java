...
public class Account {
    ...
    @JoinColumn(name = "accountNum", nullable = false, updatable = false, insertable = true)
    ...
    //Not need as Id is autogenerated in Database -- Refer to line 35
    public Account() {

    }

    //Need for Database
    public Account(Long balance, Long ledgerBalance, String accountType,
                   Double interestRate, Long overDraftPenalty, Long requiredMinimumBalance,
